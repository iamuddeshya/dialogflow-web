...
export default {
    app: {
        gateway: get_gateway_url('https://taltowidget-mshu.core.ushaflow.io'), // <- enter your gateway URL here, the function is just a helper function for my hosted integration. You don't normally need it
        muted: false, // <- mute microphone at start
        start_suggestions: ["Hi"], // <- array of suggestions, displayed at the start screen
    ...
    i18n: {
        ...
        hi: {
            ...
            muteTitle: 'Mute',
            unMuteTitle: 'Unmute',
            inputTitle: 'अपना सन्देश प्रकार करे',
            sendTitle: 'send',
            microphoneTitle: 'Voice Input'
